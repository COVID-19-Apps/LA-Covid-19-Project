...
import com.lacovid19project.Models.Test_Labs;
import com.lacovid19project.Models.Toll_Numbers;
...
public class TollNumbersAdapter extends RecyclerView.Adapter<TollNumbersAdapter.ImageViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ImageViewHolder holder, final int position) {
        ...
        holder.Phone_number.setText("Phone Number : "+test_labs.getPhone_numbers());
        holder.Remarks.setText("Remarks : "+test_labs.getRemarks());
    }
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView District, Phone_number, Remarks;
