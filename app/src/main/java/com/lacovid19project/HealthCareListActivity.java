...
import com.lacovid19project.Adapter.HealthCareListAdapter;
import com.lacovid19project.Models.HealthCareList;
...
public class HealthCareListActivity extends AppCompatActivity implements HealthCareListAdapter.SearchAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHealthCareDatabase = FirebaseDatabase.getInstance().getReference().child("health_cares").child(type);
