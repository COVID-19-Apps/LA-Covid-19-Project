...
import com.lacovid19project.Adapter.CoronaAdapter;
import com.lacovid19project.Adapter.FAQAdapter;
import com.lacovid19project.Models.Corona;
import com.lacovid19project.Models.FAQ;
import com.lacovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Ladakh").getJSONObject("districtData");
